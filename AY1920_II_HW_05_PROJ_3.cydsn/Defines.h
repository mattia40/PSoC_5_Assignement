...
/**
*   \brief Hex value to set the frequency of the accelerator in normal mode (the high-resolution mode 
...
#define LIS3DH_CTRL_REG4_BDU_ACTIVE 0x88 //high the HR bit for the high resolution mode
